...
public class AugmentCloaking : AugmentBase
{
	...
	protected override void Update()
	{
		...
		if (!m_WantDisable)
		{
			Augmentation_Cloaking augmentation_Cloaking = (Augmentation_Cloaking)Globals.m_AugmentationData.GetAugmentationContainer(AugmentationData.Augmentations.Cloaking);
			float durationPerEnergyCell = augmentation_Cloaking.GetDurationPerEnergyCell();
	...
	public override void Enable()
	{
		if (Globals.m_PlayerController.IsEnergyAvailable(0.01f, true))
		{
			...
			SoundManager.TriggerEvent("Play_Cloaking", base.gameObject);
		}
	}
	...
	public override void Disable()
	{
		if (base.enabled)
		{
			...
			m_MaterialStage = 1;
			m_MaterialTimer = m_MaterialStage1Time;
			SoundManager.TriggerEvent("Stop_Cloaking", base.gameObject);
		}
	}
