...
public class LevelScriptingTrigger : MonoBehaviour
{
	...
	public float m_ScriptingTriggerDelay;
	...
	private void OnTriggerEnter(Collider other)
	{
		...
		{
			m_ScriptingTriggerClass.Invoke(m_ScriptingTriggerName, m_ScriptingTriggerDelay);
		}
		if (m_SoundEvent != null && m_SoundEvent != string.Empty)
		{
