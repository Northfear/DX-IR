...
public class CoverFlipVolume : MonoBehaviour
{
	...
	private void Update()
	{
		...
		if (Mathf.Abs(f) < 0.05f && Globals.m_PlayerController.m_CoverState != PlayerController.CoverState.Outside && Globals.m_PlayerController.m_CoverEdge != PlayerController.CoverEdge.None)
		{
