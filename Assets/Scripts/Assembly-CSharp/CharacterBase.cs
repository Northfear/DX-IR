...
public abstract class CharacterBase : MonoBehaviour
{
	...
	protected float[] m_DamageModifiers = new float[7] { 1f, 1f, 1f, 1f, 1f, 1f, 1f };
	...
	{
		return m_Dead || !base.gameObject.active;
	}

	public virtual bool IsInCover()
	{
		return false;
	}

	public virtual bool ExposedInCover()
	{
		return false;
	}

	public virtual Vector3 GetCoverNormal()
	{
		return Vector3.zero;
	}

	public virtual Collider GetCoverCollider()
	{
		return null;
	}

	public virtual int GetGlobalLayer()
	{
		return 0;
	}

	public virtual WeaponType GetEquippedWeaponType()
	{
	...
	protected virtual void Update()
	{
		...
		if (Globals.m_PlayerController.m_TargetedEnemy == base.gameObject && m_MeshRenderer != null && m_MeshRenderer.isVisible)
		{
	...
	{
		data.m_Damage = (int)((float)data.m_Damage * m_DamageModifiers[(int)data.m_DamageType]);
		m_CurrentHealth -= data.m_Damage;
