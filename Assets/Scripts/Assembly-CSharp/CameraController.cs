...
public class CameraController : TouchDragBase
{
	...
	public float m_CameraDistThirdPerson;

	public float m_CameraHeightThirdPerson;

	public float m_CameraHeightThirdPersonStanding;
	...
	public void SetFOV(float fov, float weaponfov)
	{
		Globals.m_PlayerController.m_CurrentCamera.fieldOfView = fov;
		Globals.m_AugmentSeeThroughWalls.m_SeeThroughWallCamera.fieldOfView = fov;
		Globals.m_PlayerController.m_FirstPersonWeaponCameraComponent.fieldOfView = weaponfov;
	}
}
