...
public class InteractiveObjectManager : MonoBehaviour
{
	...
	public void PopupReleased(POINTER_INFO ptr)
	{
		...
		{
			popup.m_InteractiveObject.InteractWithObject(false);
		}
		m_PopupPressed = null;
	}
	...
	public void LethalTakedownPopupReleased(POINTER_INFO ptr)
	{
		...
		if (popup == m_PopupPressed)
		{
			((InteractiveObject_Takedown)popup.m_InteractiveObject).TakeDown(true);
		}
		m_PopupPressed = null;
	}
	...
	public void NonLethalTakedownPopupReleased(POINTER_INFO ptr)
	{
		...
		{
			((InteractiveObject_Takedown)popup.m_InteractiveObject).TakeDown(false);
		}
		m_PopupPressed = null;
	}
	...
	private void LateUpdate()
	{
		...
		while (linkedListNode != null)
		{
			...
			if (linkedListNode.Value.m_InteractiveObject != null)
			{
				...
				linkedListNode.Value.SetText(linkedListNode.Value.m_InteractiveObject);
			}
			else
			{
