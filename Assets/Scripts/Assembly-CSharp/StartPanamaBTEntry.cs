...
public class StartPanamaBTEntry : MonoBehaviour
{
	...
	public Transform m_BarracksAccess;

	public Transform m_LevelChange;
	...
	private void Start()
	{
		...
		{
			Globals.SetMissionTransforms(3, new Transform[1] { m_BarracksAccess });
		}
	}
}
