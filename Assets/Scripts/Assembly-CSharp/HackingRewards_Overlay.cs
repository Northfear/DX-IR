...
public class HackingRewards_Overlay : MonoBehaviour
{
	...
	public void AddItem(DataStoreRewardType type, int amount)
	{
		...
		case DataStoreRewardType.Money:
			...
			m_xp.Shift(m_offset);
			SoundManager.TriggerEvent("Play_Hack_Datastore_Credits", base.gameObject);
			break;
		case DataStoreRewardType.NukeVirus:
			...
			m_stopWorm.Shift(m_offset);
			m_xp.Shift(m_offset);
			SoundManager.TriggerEvent("Play_Hack_Datastore_Nuke", base.gameObject);
			break;
		case DataStoreRewardType.StopWorm:
			...
			m_nukeVirus.Shift(m_offset);
			m_xp.Shift(m_offset);
			SoundManager.TriggerEvent("Play_Hack_Datastore_Virus", base.gameObject);
			break;
		case DataStoreRewardType.XP:
			...
			m_nukeVirus.Shift(m_offset);
			m_stopWorm.Shift(m_offset);
			SoundManager.TriggerEvent("Play_Hack_Datastore_XP", base.gameObject);
			break;
		}
	}
