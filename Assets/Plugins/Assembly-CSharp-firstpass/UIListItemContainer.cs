...
public class UIListItemContainer : ControlBase, IUIListObject, IEZDragDrop, IUIContainer, IUIObject
{
	...
	public bool m_OverrideExtents;

	public Vector2 m_TopLeftEdge = Vector2.zero;

	public Vector2 m_BottomRightEdge = Vector2.zero;
	...
	public void FindOuterEdges()
	{
		...
		if (m_OverrideExtents)
		{
			topLeftEdge = m_TopLeftEdge;
			bottomRightEdge = m_BottomRightEdge;
			return;
		}
