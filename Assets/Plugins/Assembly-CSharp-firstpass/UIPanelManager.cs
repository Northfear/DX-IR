...
public class UIPanelManager : MonoBehaviour, IEZDragDrop, IUIContainer, IUIObject
{
	...
	public void BringIn(UIPanelBase panel, MENU_DIRECTION dir)
	{
		...
		if (!(curPanel == panel))
		{
			...
			SHOW_MODE mode = ((dir != MENU_DIRECTION.Forwards) ? SHOW_MODE.DismissBack : SHOW_MODE.DismissForward);
			SHOW_MODE mode2 = ((dir != MENU_DIRECTION.Forwards) ? SHOW_MODE.BringInBack : SHOW_MODE.BringInForward);
			if (curPanel != null)
			{
	...
	public void BringInImmediate(UIPanelBase panel, MENU_DIRECTION dir)
	{
		...
		SHOW_MODE transition = ((dir != MENU_DIRECTION.Forwards) ? SHOW_MODE.DismissBack : SHOW_MODE.DismissForward);
		SHOW_MODE transition2 = ((dir != MENU_DIRECTION.Forwards) ? SHOW_MODE.BringInBack : SHOW_MODE.BringInForward);
		BringIn(panel, dir);
		if (uIPanelBase != null)
		{
