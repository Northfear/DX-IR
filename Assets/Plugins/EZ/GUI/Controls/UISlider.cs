	...
	public override void Start()
	{
		...
		if (Application.isPlaying)
		{
			...
			if (!managed)
			{
				...
				{
					((SpriteMesh)knob.spriteMesh).material = base.renderer.material;
				}
			}
			...
			knob.color = ((!useKnobColor) ? color : knobColor);
